...
const texts: AppTexts = {
	...
	hero: {
		...
		date: "18.04.2022",
		backgroundAlt: "Alexia y Pablo en un momento especial",
	},
	storyQuote: {
		title: "Tú, yo y esta bonita locura",
		body: "Lo nuestro tiene ese algo que me gana siempre: risas que aparecen solas, miradas que lo dicen todo y planes improvisados que contigo siempre saben mejor.",
		card: {
			imageAlt: "Un recuerdo de nuestros comienzos",
			title: "Donde empezó todo",
			body: "Mirar atrás y encontrarnos ahí, tan al principio de todo, solo hace que me entren más ganas de seguir sumando recuerdos contigo.",
		},
	},
	gallery: {
		title: "Momentos que siempre apetece repetir",
		imageAlt: "Recuerdo de Alexia y Pablo",
	},
	closing: {
		title: "Seguir eligiéndote",
		subtitle: "Ayer, hoy y con las mismas ganas cada día.",
		cta: "Leer la carta",
	},
	letter: {
		backLabel: "Volver",
		eyebrow: "Para el amor de mi vida",
		badge: "Una carta para ti",
		title: "Lo que siempre quise decirte",
		subtitle: "Cada palabra aparece poco a poco, como un recuerdo que encuentra por fin su lugar.",
		footerCta: "Volver al inicio",
		paragraphs: [
